...
# Signal JSON output path (PUPrime MT5 Common Files folder on Linux/Wine)
SIGNAL_PATH = Path(
    "/home/ubuntu/.wine/drive_c/users/ubuntu/AppData/"
...
log_file = LOG_DIR / "puprime_signal_bot.log"
...
session_name = str(SESSION_DIR / "forexero_session2")
...
def normalize_symbol(raw: str) -> str:
    ...
    if symbol in ("XAUUSD", "GOLD", "XAUUSD.s"):
        return "XAUUSD.s"
    return symbol + ".s"
